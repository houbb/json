...
public class ArraySerialize implements ISerialize<Object> {
    ...
    public String serialize(Object object) {
        ...
        if(boolean[].class.equals(clazz)) {
            ...
            return Instances.singleton(ArrayBooleanSerialize.class).serialize(objects);
        } else if(byte[].class.equals(clazz)) {
            byte[] objects = (byte[])object;
            return Instances.singleton(ArrayByteSerialize.class).serialize(objects);
        } else if(char[].class.equals(clazz)) {
            char[] objects = (char[])object;
            return Instances.singleton(ArrayCharSerialize.class).serialize(objects);
        } else if(short[].class.equals(clazz)) {
            short[] objects = (short[])object;
            return Instances.singleton(ArrayShortSerialize.class).serialize(objects);
        } else if(int[].class.equals(clazz)) {
            int[] objects = (int[])object;
            return Instances.singleton(ArrayIntSerialize.class).serialize(objects);
        } else if(float[].class.equals(clazz)) {
            float[] objects = (float[])object;
            return Instances.singleton(ArrayFloatSerialize.class).serialize(objects);
        } else if(double[].class.equals(clazz)) {
            double[] objects = (double[])object;
            return Instances.singleton(ArrayDoubleSerialize.class).serialize(objects);
        } else if(long[].class.equals(clazz)) {
            long[] objects = (long[])object;
            return Instances.singleton(ArrayLongSerialize.class).serialize(objects);
        }
