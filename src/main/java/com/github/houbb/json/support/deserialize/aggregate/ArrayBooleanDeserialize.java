...
public class ArrayBooleanDeserialize implements IDeserialize<boolean[]> {
    ...
    @Override
    public boolean[] deserialize(String json, Class<boolean[]> aClass, IDeserializeContext context) {
        ...
        for(int i = 0; i < strings.length; i++) {
            ...
            boolean item = JsonBs.deserialize(itemJson, boolean.class, context.config());
            resultArray[i] = item;
        }
        return resultArray;
    }
